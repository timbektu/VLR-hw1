...
def main(args):
    ...
    print("Arriving HEREEEEEE")
    print(args.overfit)
    if args.overfit:
        print("Arriving HEREEEEEE ATLEAST")
    ...
    if args.test_inference:
        ...
        # Re-initialize so this cell is independent from prior cells.
        detector = FCOS(num_classes=NUM_CLASSES, fpn_channels=64, stem_channels=[64, 64])
        detector.to(device=DEVICE)
        detector.load_state_dict(torch.load(weights_path, map_location="cpu"))
